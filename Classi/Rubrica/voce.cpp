...
voce::voce(const std::string &n, const std::string &c, std::string &nt)
  : nome(n), cognome(c), ntel(nt) {}

voce::voce(const voce &other) :
  nome(other.nome), cognome(other.cognome), ntel(other.ntel) { }
...
std::ostream &operator<<(std::ostream &os, const voce &av) {
