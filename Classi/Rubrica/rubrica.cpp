...
rubrica::rubrica(void) : _voci(0), _capacity(0), _count(0) {}


//copy constructor
rubrica::rubrica(const rubrica &other) : _voci(0), _capacity(0), _count(0) {
...
void rubrica::add(const std::string &n, const std::string &c, const std::string &nt) {
  voce v(n, c, nt);
